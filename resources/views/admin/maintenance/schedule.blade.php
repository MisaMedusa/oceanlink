					...
					<table class="table table-striped table-bordered" id="table1">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><form action="/room/delete" method="post">{{csrf_field()}}<input type="hidden" name="id" value="{{$schedules->id}}"><button type="submit" class="btn btn-info">Deactivate</button></form></td>
							</tr>
							@endforeach
						</tbody>
					</table>
